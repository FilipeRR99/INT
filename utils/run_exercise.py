...
class ExerciseTopo(Topo):
    ...
    """
    def __init__(self, hosts, switches, links, log_dir, bmv2_exe, **opts):
...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir,
    ...
    def create_network(self):
        ...
        self.topo = ExerciseTopo(self.hosts, self.switches, self.links, self.log_dir, self.bmv2_exe)
        ...
        #adapted from https://forum.p4.org/t/connect-mininet-hosts-to-root-namespace/91

        for switch_name in self.outport:
...
if __name__ == '__main__':
    ...
    args = get_args()
    exercise = ExerciseRunner(args.topo, args.log_dir,
